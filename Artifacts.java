 ...
 *          Expect: isMundane
 *     - Given: ownedArtifact = InertRock("yellow"), newArtifact = new StarChart("G", -3, -1, 6)
 *          Expect: isUnknown
